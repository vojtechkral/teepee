// Lifted from Redox / smallstring
// (c) 2017 by Jack Fransham and Michael Murphy
// MIT License

use std::{str, hash, cmp, fmt};
...
impl<B: Array<Item=u8>> SmallString<B> {
    ...
    pub fn push(&mut self, ch: char) {
        match ch.len_utf8() {
            ...
            _ => self.buffer.extend_from_slice(ch.encode_utf8(&mut [0; 4]).as_bytes()),
        }
    }
}
